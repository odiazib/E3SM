...
_TESTS = {
    ...
    "e3sm_landice_developer" : {
        "tests"   : (
            "SMS.ne30pg2_r05_IcoswISC30E3r5_gis4to40.IGELM_MLI.mali-gis",
            "ERS.ne30pg2_r05_IcoswISC30E3r5_gis4to40.IGELM_MLI.mali-gis",
            "SMS.ne30pg2_r05_IcoswISC30E3r5_gis4to40.BGWCYCL1850.allactive-gis",
            "ERS.ne30pg2_r05_IcoswISC30E3r5_gis4to40.BGWCYCL1850.allactive-gis",
...
#tests for the dust emission cap
    ...
    "e3sm_ocnice_extra_coverage" : {
        ...
        "tests" : (
            ...
            "SMS_P480_Ld5.TL319_IcoswISC30E3r5.GMPAS-JRA1p5.mpaso-eke_correction_jra_1958",
            )
        },
    ...
    "e3sm_moab_ers" : {
        ...
        "tests" : (
            ...
            "ERS_Vmoab_Ld3.ne4pg2_oQU480.F2010-SCREAMv1-MPASSI",
    ...
    "e3sm_diff_dev" : {
        ...
        "tests" : (
            ...
            "SMS_Vmoab_Ld1.ne4pg2_oQU480.F2010-SCREAMv1-MPASSI",
            ...
            "SMS_Ld1.ne4pg2_oQU480.F2010-SCREAMv1-MPASSI",
